...
public class FiltradorDeGastosEspeciaisTest {
    ...
    public void soDevolveGastosComValorMaiorQueOLimite() throws Exception {
        ...
        Gasto g1 = new Gasto(25.0, "almoco", funcionario, hoje, false);
        Gasto g2 = new Gasto(150.0, "jantar", funcionario, hoje, false);
        Gasto g3 = new Gasto(22.0, "extras", funcionario, hoje, false);
